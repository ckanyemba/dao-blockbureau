...
declare const UpdateRuleGroupCommand_base: {
    new (input: UpdateRuleGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRuleGroupCommandInput, UpdateRuleGroupCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRuleGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRuleGroupCommandInput, UpdateRuleGroupCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
