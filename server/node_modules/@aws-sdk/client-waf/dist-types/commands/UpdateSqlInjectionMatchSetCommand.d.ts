...
declare const UpdateSqlInjectionMatchSetCommand_base: {
    new (input: UpdateSqlInjectionMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSqlInjectionMatchSetCommandInput, UpdateSqlInjectionMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSqlInjectionMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSqlInjectionMatchSetCommandInput, UpdateSqlInjectionMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
