...
declare const UpdateRateBasedRuleCommand_base: {
    new (input: UpdateRateBasedRuleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRateBasedRuleCommandInput, UpdateRateBasedRuleCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRateBasedRuleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRateBasedRuleCommandInput, UpdateRateBasedRuleCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
