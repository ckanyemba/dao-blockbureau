...
declare const UpdateRegexMatchSetCommand_base: {
    new (input: UpdateRegexMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRegexMatchSetCommandInput, UpdateRegexMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRegexMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRegexMatchSetCommandInput, UpdateRegexMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
