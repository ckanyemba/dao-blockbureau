...
declare const UpdateXssMatchSetCommand_base: {
    new (input: UpdateXssMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateXssMatchSetCommandInput, UpdateXssMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateXssMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateXssMatchSetCommandInput, UpdateXssMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
