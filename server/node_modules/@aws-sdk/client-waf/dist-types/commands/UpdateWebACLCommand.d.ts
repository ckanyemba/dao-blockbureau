...
declare const UpdateWebACLCommand_base: {
    new (input: UpdateWebACLCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWebACLCommandInput, UpdateWebACLCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateWebACLCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWebACLCommandInput, UpdateWebACLCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
