...
declare const UpdateSizeConstraintSetCommand_base: {
    new (input: UpdateSizeConstraintSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSizeConstraintSetCommandInput, UpdateSizeConstraintSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSizeConstraintSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSizeConstraintSetCommandInput, UpdateSizeConstraintSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
