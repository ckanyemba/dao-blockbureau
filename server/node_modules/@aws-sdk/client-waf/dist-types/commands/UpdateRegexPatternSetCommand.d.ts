...
declare const UpdateRegexPatternSetCommand_base: {
    new (input: UpdateRegexPatternSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRegexPatternSetCommandInput, UpdateRegexPatternSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRegexPatternSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRegexPatternSetCommandInput, UpdateRegexPatternSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
