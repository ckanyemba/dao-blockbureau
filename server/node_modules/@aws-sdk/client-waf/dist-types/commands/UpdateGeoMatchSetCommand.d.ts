...
declare const UpdateGeoMatchSetCommand_base: {
    new (input: UpdateGeoMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGeoMatchSetCommandInput, UpdateGeoMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateGeoMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGeoMatchSetCommandInput, UpdateGeoMatchSetCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
