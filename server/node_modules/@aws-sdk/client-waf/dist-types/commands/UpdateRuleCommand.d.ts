...
declare const UpdateRuleCommand_base: {
    new (input: UpdateRuleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRuleCommandInput, UpdateRuleCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRuleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRuleCommandInput, UpdateRuleCommandOutput, WAFClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
